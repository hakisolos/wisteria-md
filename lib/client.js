...
const { lightningCache, cacheHelpers } = require('./cache.js');
const cacheRedis = require("./utilities/cache.js")
...
async function startWisteria() {
    ...
    sock.ev.on('messages.upsert', async m => {
        try {
            ...
            await cacheRedis.cacheGroup(jid, sock)
            
            console.log(`Group ${jid}, cached successfully`)
        } catch (err) {
