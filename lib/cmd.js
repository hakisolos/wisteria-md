...
export function nikka(options, callback) {
	if (options.on) {
...
export function hasPermission(m, cmd) {
...
export async function executeCommand(m) {
...
export async function handleEvent(m) {
...
export function getMessageContentType(messageContent) {
...
export function installPluginFromCode(pluginCode) {
	try {
...
export async function loadCommands() {
	...
	const files = fs
		...
		.filter(file => file.endsWith('.haki'));
